...
// Rate limiting - Relaxed for Development and High-Throughput Demo
const limiter = rateLimit({
  windowMs: 15 * 60 * 1000, 
  max: 10000, // Effectively infinite for local dev
  message: { error: 'TOO_MANY_REQUESTS', message: 'Local rate limit exceeded.' }
});
app.use('/api/', limiter);
