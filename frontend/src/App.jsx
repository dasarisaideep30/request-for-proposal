      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '2.5rem', paddingTop: '1.5rem', borderTop: '1px solid #f1f5f9' }}>
          <button type="submit" className="btn btn-primary" disabled={loading} style={{ flex: 1, padding: '1rem' }}>
            {loading ? 'Creating...' : 'Finalize & Save Proposal'}
          </button>
          <button type="button" className="btn btn-secondary" onClick={onCancel} style={{ flex: 1, padding: '1rem' }}>
            Discard
          </button>
        </div>
      </form>
      ...
      <main className="main-content">
        ...
        <div className="content-area">
          <div className={`view-container ${currentView === 'dashboard' ? '' : 'hidden'}`}>
            <Dashboard data={dashboardData} loading={dataLoading} onRefresh={refreshDashboard} onViewRFP={handleViewRFP} />
          </div>
